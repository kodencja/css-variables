...
describe("Background Color", () => {
  ...
  test("should render input", async () => {
    render(<BgrCol onChanging={mockedOnChanging} onValue={mockedState} />);
  ...
  it("should call onChanging method 1 time and the right value", () => {
    ...
    render(<BgrCol onChanging={mockedOnChanging} onValue={{}} />);
  ...
  it("should be able to render output initial text", async () => {
    ...
    const { getByLabelText } = render(
      <BgrCol onChanging={mockedHandleChanging} onValue={mockedState} />
    );
  ...
  it("should be able to change input value with currentValue", async () => {
    const { getByRole } = render(
      <BgrCol onChanging={mockedOnChanging} onValue={currentValue} />
    );
